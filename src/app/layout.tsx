      ...
      <body>
        <nav className="navbar">
          <div className="container flex items-center justify-between">
            ...
            <div className="flex gap-6 items-center hidden md:flex">
              ...
              <Link href="/request" className="nav-link flex items-center gap-2">
        ...
        <footer style={{ backgroundColor: 'var(--secondary)', color: 'var(--text-light)', padding: '3rem 0', textAlign: 'center' }}>
          <div className="container">
            ...
            <h3 style={{ color: 'var(--surface)', marginBottom: '0.5rem' }}>Gopalganj Blood Bank</h3>
            <p style={{ color: '#cbd5e1', marginBottom: '2rem' }}>Every drop counts. Join our mission to save lives in Gopalganj.</p>
            <div style={{ borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: '1.5rem', fontSize: '0.875rem', color: '#94a3b8' }}>
              &copy; {new Date().getFullYear()} Gopalganj Blood Bank. All rights reserved.
            </div>
          </div>
        </footer>
      </body>
